...
public class Giron {
	...
	public Giron(String direccion, String departamento, String ciudad, Integer habitaciones, Integer banos,
			Integer metros2, String condicion, String precio, String tipo) {
		super();
		this.direccion = direccion;
		this.departamento = departamento;
	...
	public String toString() {
		return "Giron [id=" + id + ", direccion=" + direccion + ", departamento=" + departamento + ", ciudad=" + ciudad
