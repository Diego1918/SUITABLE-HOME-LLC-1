...
@Entity
@Table(name = "manizales")
public class Manizales {
	@Id
	...
	public Manizales(Long id, String direccion, String departamento, String ciudad, Integer habitaciones, Integer banos,
	...
	public Manizales(String direccion, String departamento, String ciudad, Integer habitaciones, Integer banos,
			Integer metros2, String condicion, String precio, String tipo) {
		super();
		this.direccion = direccion;
		this.departamento = departamento;
	...
	public String toString() {
		return "Manizales [id=" + id + ", direccion=" + direccion + ", departamento=" + departamento + ", ciudad="
