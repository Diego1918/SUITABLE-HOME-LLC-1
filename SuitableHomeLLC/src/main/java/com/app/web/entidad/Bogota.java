...
public class Bogota {
	...
	public Bogota(Long id, String direccion, String departamento, String ciudad, Integer habitaciones, Integer banos,
	...
	public Bogota(String direccion, String departamento, String ciudad, Integer habitaciones, Integer banos,
			Integer metros2, String condicion, String precio, String tipo) {
		super();
		this.direccion = direccion;
		this.departamento = departamento;
	...
	public String toString() {
		return "Bogota [id=" + id + ", direccion=" + direccion + ", departamento=" + departamento + ", ciudad=" + ciudad
